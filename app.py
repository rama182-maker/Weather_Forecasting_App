...
owm = pyowm.OWM('ecd57514f8a2e900f04d69d1bc20769d')
mgr=owm.weather_manager()

degree_sign= u'\N{DEGREE SIGN}'

st.title("5 Day Weather Forecast")
st.write("## Made by Ramakrishna")

st.write("### Enter the name of a City and choose a unit of Temperature and Graph Type from the sidebar")

place=st.text_input("Name of City :", "")
...
unit=st.selectbox("Select Unit of Temperature",("Celsius","Fahrenheit"))
